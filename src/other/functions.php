...
?>
   <title><?php bloginfo('name'); ?> | <?php if (is_404()) {echo '404';}; single_post_title(); ?></title>
   ...
   <meta name="application-name" content="prduct.com">
...
add_action('wp_enqueue_scripts', function () {
   ...
   wp_register_script('jquery', get_template_directory_uri() . '/vendor/js/jquery-3.7.0.js', false, "3.7.0", true);
